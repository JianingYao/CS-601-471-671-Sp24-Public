...
class SentimentClassifier(nn.Module):
    def __init__(self, embed_dim: int, num_classes: int, hidden_dims: List[int], activation: str = 'Sigmoid'):
        ...
        if activation == 'Sigmoid':
            ...
            raise NotImplementedError(f"The activation function {activation} is not supported. Choose from 'Sigmoid', 'Tanh', 'ReLU', and 'GeLU'.")
        ...
        layer_dims = [self.embed_dim] + hidden_dims + [self.num_classes]
