...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        #   The matrix should has 1s in the lower left triangular part (including the diagonal)
        #   and 0s in the upper right.
    ...
    def forward(self, x):
        ...
        # causal self-attention; Self-attend: (B, n_head, T, n_embd / n_head) x
